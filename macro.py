...
inflation = cpi.pct_change(periods=12) * 100  # YoY % change
...
# (1) Inflation & Interest Rate Trend
...
# (3) Rolling BTC–S&P Correlation vs Inflation & Interest Rates
btc_sp_corr = returns["BTC-USD"].rolling(12).corr(returns["^GSPC"])
btc_sp_corr.name = "BTC–S&P500 Correlation"
